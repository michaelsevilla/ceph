...
if [ $1 == "apply" ]; then
  ...
  bin/cephfs-journal-tool journal import test.bin; sleep 10
...
#
#  # Pop, drop, and lock it: decouple namespace, save inode range
#  for i in "a" "b" "c"; do
...
#  echo "start=$START end=$END"
  ...
  #bin/cephfs-journal-tool journal import journal.bin
